...
`,h=l.I4.div`
  ...
  padding-top: 16px;
`;function p({description:e,onConfirm:t,onHide:i,open:l,title:p}){const[u,m]=(0,n.useState)(!0),[g,f]=(0,n.useState)(""),b=()=>{f(""),t()};return(0,c.FD)(o.A,{disablePrimaryButton:u,onHide:()=>{f(""),i()},onHandledPrimaryAction:b,primaryButtonName:(0,r.t)("Delete"),primaryButtonType:"danger",show:l,title:p,centered:!0,children:[(0,c.Y)(h,{children:e}),(0,c.FD)(d,{children:[(0,c.Y)(s.lR,{htmlFor:"delete",children:(0,r.t)('Type "%s" to confirm',(0,r.t)("DELETE"))}),(0,c.Y)(a.pd,{type:"text",id:"delete",autoComplete:"off",value:g,onChange:e=>{var t;const i=null!=(t=e.target.value)?t:"";m(i.toUpperCase()!==(0,r.t)("DELETE")),f(i)},onPressEnter:()=>{u||b()}})]})]})}},94704:(e,t,i)=>{i.d(t,{A:()=>h});var l=i(96540),r=i(96453),n=i(17437),a=i(95579),o=i(19129),s=i(12249),c=i(2445);const d=r.I4.a`
  ${({theme:e})=>n.AH`
