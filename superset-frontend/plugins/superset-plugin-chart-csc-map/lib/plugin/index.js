 ...
 * under the License.
 */
class SupersetPluginChartCscMap extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      ...
      name: (0, _core.t)('CSC Map'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetPluginChartCscMap'))),
      metadata,
      transformProps: _transformProps.default
    });
  }
}
exports.default = SupersetPluginChartCscMap;